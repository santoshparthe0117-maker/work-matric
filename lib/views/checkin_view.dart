...
import 'package:workmetric/views/worker_account_page.dart'
    show WorkerAccountSection;
import 'package:workmetric/views/worker_home_page.dart' show WorkerHomeSection;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<User?>(
      ...
      builder: (context, snap) {
        ...
        final tabs = [
          WorkerHomeSection(user: firebaseUser),
          WorkerAccountSection(user: firebaseUser),
        ];
        ...
        return Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            selectedItemColor: const Color.fromARGB(255, 119, 43, 242),
